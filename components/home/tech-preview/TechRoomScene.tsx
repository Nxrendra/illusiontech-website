        ...
        <>
          ...
          {!activeHotspot && (
            <motion.div
              ...
              className="absolute bottom-4 left-0 right-0 mx-auto w-fit sm:bottom-6 sm:left-auto sm:right-24 sm:mx-0 flex items-center gap-1 sm:gap-4 bg-black/50 backdrop-blur-lg p-1.5 sm:p-3 rounded-full border border-white/10 shadow-2xl z-10 max-w-[calc(100vw-2rem)] sm:max-w-[95vw] overflow-x-auto"
            >
              {/* View Controls */}
