      ...
      <div className="container grid md:grid-cols-2 gap-16 items-center">
        <motion.div variants={containerVariants} className="max-w-lg space-y-4">
          <motion.div variants={createItemVariantsLeft(isMobile)}>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">Why Choose IllusionTech?</h2>
          </motion.div>
          <motion.div variants={createItemVariantsLeft(isMobile)}>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              We're more than just developers; we're your dedicated partners in building a powerful online presence that drives growth and delivers results.
            </p>
          </motion.div>
