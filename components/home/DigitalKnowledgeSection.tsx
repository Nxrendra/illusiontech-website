...
export function DigitalKnowledgeSection() {
    ...
    <AnimatedSection id="digital-knowledge" className="py-20 md:py-28 bg-muted" viewport={{ once: false, amount: 0.2 }}>
      <div className="container">
        <SectionHeader
          ...
          description="Knowledge is power. We believe in empowering our clients by explaining the 'why' behind the 'what'. Here are some core concepts vital to understanding the web and making informed decisions for your project."
          isMobile={isMobile}
        />
